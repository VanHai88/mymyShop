...
import com.nguyenvanhai.ecommerce.Model.Cart;
import com.nguyenvanhai.ecommerce.Prevalent.Prevalent;
import com.nguyenvanhai.ecommerce.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setHasFixedSize(true); // fix kich thuoc co dinh
                                    ...
                                    cartListRef.child("User View")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if(task.isSuccessful()){ // task thanh cong
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(shippingState.equals("shipped")){
                        ...
                        Toast.makeText(CartActivity.this, "you can purchase more products, once your first final order.", Toast.LENGTH_SHORT).show();
                    }
